...
class WindowsGoldenProbe:
    ...
    def windows_inventory(self) -> dict[str, object]:
        return {
            ...
            "storage": [{"serial": "SSD-01", "model": "Example SSD", "size_bytes": 512110190592, "media_type": "UNKNOWN", "bus_type": "UNKNOWN"}],
            "storage_details": [{"serial": "SSD-01", "model": "Example SSD", "size_bytes": 512110190592, "media_type": "SSD", "bus_type": "NVMe"}],
