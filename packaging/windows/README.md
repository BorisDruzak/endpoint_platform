...
The reviewed `initial-runtime-3.2.17.json` transition adds the safe provisioning
fingerprint status mode with a new component GUID and must be built with both explicit
