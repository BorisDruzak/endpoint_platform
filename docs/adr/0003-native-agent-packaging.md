...
The inherited `pyinstaller_agent_*.spec` files and `pc_agent/requirements.txt`
remain available solely for reproducible historic Helpdesk/GUI artifacts. They
must not be used to create new MSI or RPM packages.
